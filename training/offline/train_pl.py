...
def arg_parser_for_offline_training():
    ...
    parser.add_argument("--model_version", type=str, default="siglip_base_3")
    parser.add_argument("--loss", type=str, default="action")
    parser.add_argument("--dataset_version", type=str, default="SINGLE_TASK")
    parser.add_argument("--data_dir", type=str, default="/media/yucheng/Elements/fifteen")
    ...
    parser.add_argument("--per_gpu_batch", type=int, default=2)
    ...
    parser.add_argument("--precision", type=str, default="16-mixed", choices=["32-true", "16-mixed"])
    ...
    parser.add_argument(
        "--input_sensors",
        nargs="+",
        default=["raw_navigation_camera", "raw_manipulation_camera", "last_actions"],
    )
    return parser
